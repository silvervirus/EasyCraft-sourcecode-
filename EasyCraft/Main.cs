...
namespace EasyCraft
{
  public class Main : MonoBehaviour
  {
    ...
    public static bool Construct(Constructable construct)
    {
      ...
      if (construct._constructed != false)
        return false;
      ...
      constructable.constructedAmount = (__false) (constructable.constructedAmount + (double) Time.maximumDeltaTime() / ((double) count * (double) num1));
